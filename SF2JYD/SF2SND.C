/*
   ...
   ´—aŸ³‰Á ¬a§i žË¥·e ?¯aŸi ´è´á¬á ¬s·³? ˆõ ·³“¡”a.  
...
/***
   ...
   index port Address 0x70  ·¥•B¯a Í¡? ´á—aA¯a 
   data  port Address 0x71  •A·¡? Í¡? ´á—aA¯a

   inportance data address º—¶a? •A·¡? ´á—aA¯a
...
/* CMOS RAMµA¬á •A·¡?Ÿi ·ª“e”a */
#define CMOS_READ(I)    (outportb(0x70,(I)) , inportb(0x71))

#define CMOSINTVECT 0x70 /* ??ˆe ?œâ ·¥Èáœó? ¥BÈá */
void interrupt (*oldRTC)(void) ; /* ¶¥œ· ??ˆe ?œâ ·¥Èáœó? ¥BÈá */

#define BUSY 1 /* ·q? Â‰b º— */
#define IDLE 0 /* ·q? Â‰b·i ´e? */
#define MAX_VOICE_SIZE 20000 /* ·q? ¸aža· ÂA” ?‹¡ */

unsigned char *VoiceData,VoiceFlag=IDLE ; /* ·q? •A·¡? Í¡·¥Èá , ·q? ¬w? ?A‹a */
int VoiceDataSize,VoiceDataBytePoint ; /* ·q?•A·¡? ?‹¡, ?¸·q? ¸aža ¤åÑ¡*/
...
#define NO_VOICE      0 /* ·q? Â‰b·i ?»¡ ´g“e”a */
#define PC_SPEAKER    1 /* Ï¡³¡ ¯aÏ¡Äá¡ ·q? Â‰b */
#define SOUND_BLASTER 2 /* ¬a¶…—a §iœ¯aÈá¡ ·q? Â‰b */
#define COVOX1        3 /* Å¡¥¢¯aˆa ?Ÿ¥Èá Í¡? 1µA µe‰i */
#define COVOX2        4 /* Å¡¥¢¯aˆa ?Ÿ¥Èá Í¡? 2µA µe‰i */

#define COLOR_LPT1_PORT 0x378 /* Äéœá ´á”“Èá ?Ÿ¥Èá Í¡? 1 */
#define COLOR_LPT2_PORT 0x278 /* Äéœá ´á”“Èá ?Ÿ¥Èá Í¡? 2 */
#define MONO_LPT1_PORT  0x3bc /* Ðá?A¯a ´á”“Èá ?Ÿ¥Èá Í¡? 1 */
