...
void aput_eng_font(int x, int y, unsigned char code, unsigned char attr)
{
   ...
   zoomed_out_8(x, y, eng_font[code], attr);

   asm  jmp     quit_put_eng

   modify:

   modify_image(or_font, eng_font[code], 16, attr);
