...
{
   mini bul1, bul2, bul3, cho, jung, jong;
   mini color, bkcolor;
   ...
   zoomed_out_16(x, y, or_font, attr);
   asm  jmp     quit_put_han

   modify_han:

   modify_image(or_font, or_font, 32, attr);
